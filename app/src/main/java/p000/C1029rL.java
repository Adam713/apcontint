...
/* renamed from: rL */
class C1029rL implements TextWatcher {

    /* renamed from: a */
    public final /* synthetic */ Customer_Det_List_edit2 f3682a;

    public C1029rL(Customer_Det_List_edit2 customer_Det_List_edit2) {
        this.f3682a = customer_Det_List_edit2;
    }
    ...
    public void onTextChanged(CharSequence r2, int r3, int r4, int r5) {
        /*
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r2 = r1.f3682a
            android.widget.AutoCompleteTextView r5 = r2.f2387n
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r0 = r1.f3682a
            android.widget.AutoCompleteTextView r0 = r0.f2387n
        ...
        L_0x0021:
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r2 = r1.f3682a
            android.widget.AutoCompleteTextView r2 = r2.f2387n
        ...
        L_0x002e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C1029rL.onTextChanged(java.lang.CharSequence, int, int, int):void");
    }
}
