...
/* renamed from: cK */
class C0641cK implements OnClickListener {

    /* renamed from: a */
    public final /* synthetic */ String[] f1935a;

    /* renamed from: b */
    public final /* synthetic */ Customer_Det_List_edit f1936b;

    public C0641cK(Customer_Det_List_edit customer_Det_List_edit, String[] strArr) {
        this.f1936b = customer_Det_List_edit;
        this.f1935a = strArr;
    }
    ...
    public void onClick(android.content.DialogInterface r6, int r7) {
        /*
            r5 = this;
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r6 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            boolean r6 = p000.C0760eU.m2615a(r6)     // Catch:{ Exception -> 0x00fe }
            java.lang.String[] r0 = r5.f1935a     // Catch:{ Exception -> 0x00fe }
            r0 = r0[r7]     // Catch:{ Exception -> 0x00fe }
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r1 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r7 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r0 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            ...
            r7.f2300ia = r0     // Catch:{ Exception -> 0x00fe }
            if (r6 == 0) goto L_0x00fe
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r6 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            r6.mo3628g()     // Catch:{ Exception -> 0x00fe }
            goto L_0x00fe
        L_0x003a:
            java.lang.String[] r0 = r5.f1935a     // Catch:{ Exception -> 0x00fe }
            r0 = r0[r7]     // Catch:{ Exception -> 0x00fe }
            ...
            if (r6 == 0) goto L_0x00fe
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r6 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            r6.mo3657t()     // Catch:{ Exception -> 0x00fe }
            goto L_0x00fe
        L_0x006b:
            java.lang.String[] r6 = r5.f1935a     // Catch:{ Exception -> 0x00fe }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r6 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            JU r6 = r6.f2285b     // Catch:{ Exception -> 0x00fe }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r0 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            android.widget.ImageView r0 = r0.f2329x     // Catch:{ Exception -> 0x00fe }
        ...
        L_0x00a9:
            ...
            if (r6 == 0) goto L_0x00fe
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit r6 = r5.f1936b     // Catch:{ Exception -> 0x00fe }
            android.widget.ImageView r6 = r6.f2329x     // Catch:{ Exception -> 0x00fe }
            r7 = 0
        ...
        L_0x00fe:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0641cK.onClick(android.content.DialogInterface, int):void");
    }
}
