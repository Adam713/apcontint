...
/* renamed from: XK */
class C0496XK implements OnClickListener {

    /* renamed from: a */
    public final /* synthetic */ String[] f1434a;

    /* renamed from: b */
    public final /* synthetic */ Customer_Det_List_edit2 f1435b;

    public C0496XK(Customer_Det_List_edit2 customer_Det_List_edit2, String[] strArr) {
        this.f1435b = customer_Det_List_edit2;
        this.f1434a = strArr;
    }
    ...
    public void onClick(android.content.DialogInterface r6, int r7) {
        /*
            r5 = this;
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r6 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            boolean r6 = p000.C0760eU.m2615a(r6)     // Catch:{ Exception -> 0x00d0 }
            java.lang.String[] r0 = r5.f1434a     // Catch:{ Exception -> 0x00d0 }
            r0 = r0[r7]     // Catch:{ Exception -> 0x00d0 }
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r1 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r7 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r0 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            ...
            r7.f2382ka = r0     // Catch:{ Exception -> 0x00d0 }
            if (r6 == 0) goto L_0x00d0
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r6 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            r6.mo3726i()     // Catch:{ Exception -> 0x00d0 }
            goto L_0x00d0
        L_0x003a:
            java.lang.String[] r0 = r5.f1434a     // Catch:{ Exception -> 0x00d0 }
            r0 = r0[r7]     // Catch:{ Exception -> 0x00d0 }
            ...
            if (r6 == 0) goto L_0x00d0
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r6 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            r6.mo3757x()     // Catch:{ Exception -> 0x00d0 }
            goto L_0x00d0
        L_0x006a:
            java.lang.String[] r6 = r5.f1434a     // Catch:{ Exception -> 0x00d0 }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r6 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            JU r6 = r6.f2363b     // Catch:{ Exception -> 0x00d0 }
            ...
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r0 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            android.widget.ImageView r0 = r0.f2409y     // Catch:{ Exception -> 0x00d0 }
        ...
        L_0x00a8:
            ...
            if (r6 == 0) goto L_0x00d0
            com.valdio.valdioveliu.recyclerview.Customer_Det_List_edit2 r6 = r5.f1435b     // Catch:{ Exception -> 0x00d0 }
            android.widget.ImageView r6 = r6.f2409y     // Catch:{ Exception -> 0x00d0 }
            r7 = 0
        ...
        L_0x00d0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0496XK.onClick(android.content.DialogInterface, int):void");
    }
}
