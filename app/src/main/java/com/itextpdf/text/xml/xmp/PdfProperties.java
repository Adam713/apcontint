...
public class PdfProperties {
    ...
    public static void setKeywords(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/pdf/1.3/", KEYWORDS, str);
    }

    public static void setProducer(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/pdf/1.3/", PRODUCER, str);
    }

    public static void setVersion(XMPMeta xMPMeta, String str) {
