...
public class XmpBasicProperties {
    ...
    public static void setCreateDate(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/xap/1.0/", CREATEDATE, str);
    }

    public static void setCreatorTool(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/xap/1.0/", CREATORTOOL, str);
    }

    public static void setIdentifiers(XMPMeta xMPMeta, String[] strArr) {
    ...
    public static void setMetaDataDate(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/xap/1.0/", METADATADATE, str);
    }

    public static void setModDate(XMPMeta xMPMeta, String str) {
        xMPMeta.setProperty("http://ns.adobe.com/xap/1.0/", MODIFYDATE, str);
    }

    public static void setNickname(XMPMeta xMPMeta, String str) {
