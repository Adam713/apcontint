...
public class ParseRDF implements XMPError, XMPConst {
    ...
    public static XMPNode addChildNode(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, String str, boolean z) {
    ...
    public static XMPNode addQualifierNode(XMPNode xMPNode, String str, String str2) {
    ...
    public static void fixupQualifiedNode(XMPNode xMPNode) {
    ...
    public static int getRDFTermKind(Node node) {
        ...
        if (str3.equals(namespaceURI)) {
            if (Tag.f2042LI.equals(localName)) {
                return 9;
            }
    ...
    public static XMPMetaImpl parse(Node node) {
    ...
    public static void rdf_EmptyPropertyElement(com.itextpdf.xmp.impl.XMPMetaImpl r16, com.itextpdf.xmp.impl.XMPNode r17, Node r18, boolean r19) {
        /*
            r0 = r16
        ...
        L_0x00b3:
            ...
            r8 = r18
            r9 = r19
            com.itextpdf.xmp.impl.XMPNode r3 = addChildNode(r0, r3, r8, r1, r9)
            if (r4 != 0) goto L_0x00cf
            if (r5 == 0) goto L_0x00c4
            goto L_0x00cf
        L_0x00c4:
            if (r6 == 0) goto L_0x00e2
            com.itextpdf.xmp.options.PropertyOptions r1 = r3.getOptions()
            r5 = 1
            r1.setStruct(r5)
            goto L_0x00e3
        L_0x00cf:
    ...
    public static void rdf_LiteralPropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        ...
        for (int i2 = 0; i2 < node.getAttributes().getLength(); i2++) {
            ...
            if (!str.equals(prefix) && (item.getPrefix() != null || !str.equals(item.getNodeName()))) {
    ...
    public static void rdf_NodeElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    public static void rdf_NodeElementAttrs(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        int i = 0;
        for (int i2 = 0; i2 < node.getAttributes().getLength(); i2++) {
            Node item = node.getAttributes().item(i2);
            String prefix = item.getPrefix();
    ...
    public static void rdf_NodeElementList(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node) {
    ...
    public static void rdf_ParseTypeResourcePropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    public static void rdf_PropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    public static void rdf_PropertyElementList(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        for (int i = 0; i < node.getChildNodes().getLength(); i++) {
            Node item = node.getChildNodes().item(i);
            if (!isWhitespaceNode(item)) {
    ...
    public static void rdf_RDF(XMPMetaImpl xMPMetaImpl, Node node) {
    ...
    public static void rdf_ResourcePropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        if (z) {
        ...
        while (true) {
            ...
            if (i < length) {
                Node item = node.getAttributes().item(i);
                String prefix = item.getPrefix();
                String str2 = SecurityConstants.XMLNS;
                if (!str2.equals(prefix) && (item.getPrefix() != null || !str2.equals(item.getNodeName()))) {
                    String localName = item.getLocalName();
                    String namespaceURI = item.getNamespaceURI();
                    String nodeName = item.getNodeName();
