...
public class XMPUtilsImpl implements XMPConst {
    ...
    public static void appendSubtree(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, XMPNode xMPNode2, boolean z, boolean z2) {
    ...
    public static boolean itemValuesMatch(XMPNode xMPNode, XMPNode xMPNode2) {
        boolean z;
        PropertyOptions options = xMPNode.getOptions();
    ...
    public static XMPNode separateFindCreateArray(String str, String str2, PropertyOptions propertyOptions, XMPMetaImpl xMPMetaImpl) {
