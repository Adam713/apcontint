...
public class XMPNodeUtils implements XMPConst {
    ...
    public static int findIndexedItem(XMPNode xMPNode, String str, boolean z) {
        try {
    ...
    public static XMPNode findQualifierNode(XMPNode xMPNode, String str, boolean z) {
    ...
    public static XMPNode followXPathStep(XMPNode xMPNode, XMPPathSegment xMPPathSegment, boolean z) {
        int i;
    ...
    public static int lookupFieldSelector(XMPNode xMPNode, String str, String str2) {
        int i = 1;
        int i2 = -1;
    ...
    public static int lookupQualSelector(XMPNode xMPNode, String str, String str2, int i) {
        ...
        if (str3.equals(str)) {
            ...
            XMPNode xMPNode2 = new XMPNode(XMPConst.ARRAY_ITEM_NAME, null);
            xMPNode2.addQualifier(new XMPNode(str3, "x-default", null));
            xMPNode.addChild(1, xMPNode2);
            return 1;
        }
    ...
    public static void normalizeLangArray(XMPNode xMPNode) {
        if (xMPNode.getOptions().isArrayAltText()) {
            ...
            while (true) {
                ...
                XMPNode child = xMPNode.getChild(i);
                if (child.hasQualifier()) {
                    if ("x-default".equals(child.getQualifier(1).getValue())) {
                        try {
