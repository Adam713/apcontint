...
public class XMPSerializerRDF {
    ...
    public static final Set RDF_ATTR_QUALIFIER = new HashSet(Arrays.asList(new String[]{XMPConst.XML_LANG, "rdf:resource", "rdf:ID", "rdf:bagID", "rdf:nodeID"}));
    public static final String RDF_EMPTY_STRUCT = "<rdf:Description/>";
    ...
    private boolean canBeRDFAttrProp(XMPNode xMPNode) {
        if (!xMPNode.hasQualifier() && !xMPNode.getOptions().isURI() && !xMPNode.getOptions().isCompositeProperty() && !xMPNode.getOptions().containsOneOf(PropertyOptions.SEPARATE_NODE)) {
    ...
    private void serializeCanonicalRDFProperty(XMPNode r17, boolean r18, boolean r19, int r20) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void serializeCompactRDFElementProps(XMPNode r11, int r12) {
        /*
            r10 = this;
