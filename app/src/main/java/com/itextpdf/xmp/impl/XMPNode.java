...
public class XMPNode implements Comparable {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<com.itextpdf.xmp.impl.XMPNode>, for r3v0, types: [java.util.List, java.util.List<com.itextpdf.xmp.impl.XMPNode>] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private XMPNode find(List<XMPNode> r3, String r4) {
        /*
            r2 = this;
        ...
        L_0x001d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.xmp.impl.XMPNode.find(java.util.List, java.lang.String):com.itextpdf.xmp.impl.XMPNode");
    }
